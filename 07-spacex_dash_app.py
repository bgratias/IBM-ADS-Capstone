...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        # filter for chosen launch site
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        # group by outcome class
        filtered_df = filtered_df.groupby(['Launch Site', 'class']).size().reset_index(name='outcome')
        
        # return filtered outcomes pie chart
        fig = px.pie(filtered_df, 
            values='outcome', 
            names='outcome', 
            title='Total Sucessful vs Failed Launches')
        return fig
...
def get_scatter_chart(entered_site,entered_payload):
    # filter for payload min/max values
    filtered_df = spacex_df[
    ...
    if entered_site == 'ALL':
        ...
        # return filtered outcomes scatter chart
        fig = px.scatter(
            filtered_df, 
            x='Payload Mass (kg)', 
            y='class', 
